...
public class CryptoUtils {
    ...
    private static SecretKeySpec getSecretKeySpec(String alName , String key) throws Exception{
     ...
     * @return
     */
    public static String decryptAES(String content, String aesKey) throws Exception {
